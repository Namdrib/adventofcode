...
public class day07 {
  ...
  public int getCorrectWeight() {
    ...
    System.out.println(
        "It's the one whose total weight (as a child) differs from the rest of its parents children");
    System.out.println(
        "Its actual weight must be adjusted by the difference between its parents children and its own total weight");
    return 0;
  }
